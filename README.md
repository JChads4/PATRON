...
1. Clone repository:
```bash
git clone https://github.com/JChads4/RotBandSim.git
cd RotBandSim
```
...
nucleus:
  ...
  gamma_peak: 257  # Peak for normalization
  gamma_range: 3   # Range for normalization

files:
  level_scheme: data/level_schemes/254No_isomer.txt
  exp_electron: data/experimental/your_electron_file.dat  # Optional
  exp_gamma: data/experimental/your_gamma_file.dat        # Optional

experiment:
  hv_barrier: 25  # Electric field barrier
